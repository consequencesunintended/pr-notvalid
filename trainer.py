...
class Trainer:
    ...
    def train(self):
        ...
        data_loader = DataLoader(train_dataset, batch_size=batch_size_count)
        ...
        for epoch in range(0, 1):
            ...
            running_loss = 0.0  # Initialize before your training loop
            ...
            for i, batch in enumerate(data_loader):
                ...
                noise_pred = unet(latent_model_input, timesteps, encoder_hidden_states, class_labels=task_emb, return_dict=False)[0]
                ...
                number_images_done = ((i + 1) * batch_size_count)
                actual_step = number_images_done // gradient_batch_size

                if number_images_done % gradient_batch_size == 0 and actual_step != 0:
                    average_loss = running_loss / gradient_batch_size
                    print(f'step:{actual_step} -- loss:{average_loss}')
